...
<head>
    ...
    <script type="text/javascript" src="<?= constant('URL') ?>assets/js/tables/inventory/fetchthreads.js" defer></script>
</head>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">Inventario de hilos</h5>
                        </div>

...
<head>
    ...
    <script type="text/javascript" src="<?= constant('URL') ?>assets/js/tables/inventory/fetchvinyls.js" defer></script>
                ...
                <div class="w-full p-3">
                    ...
                    <div class="bg-white border rounded shadow">
                        <div class="border-b p-3">
                            <h5 class="font-bold uppercase text-gray-600">Inventario de vinilos</h5>
                        </div>

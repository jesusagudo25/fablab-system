    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
        ...
        <div class="flex flex-row flex-wrap flex-grow mt-2">
            ...
            <div class="w-full p-3">
                <!--Graph Card-->
                    <button id="observacion" class="w-1/6 px-4 py-2 text-sm font-bold uppercase leading-5 text-center text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg active:bg-blue-600 hover:bg-blue-700 focus:outline-none"><i class="fas fa-sticky-note fa-fw mr-3"></i> Nueva observación</button>
                <!--/Graph Card-->
            </div>
